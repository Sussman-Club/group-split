...
public class GroupCreateTest(ApiTestFixture fixture) : ApiUnitTest(fixture)
{
    ...
    public async Task CreateGroup_CreatesNewGroupAndAddsCurrentUser()
    {
        ...
        // Act
        var result = await groupService.CreateGroup(TestContext.Current.CancellationToken);
    ...
    public async Task CreateGroup_MultipleCallsCreateSeparateGroups()
    {
        ...
        // Act
        var group1 = await groupService.CreateGroup(TestContext.Current.CancellationToken);
        var group2 = await groupService.CreateGroup(TestContext.Current.CancellationToken);
        ...
        var groupCount = await DbContext.Set<GroupSplit.Data.Entities.Group>()
            .CountAsync(g => g.Id == group1.Id || g.Id == group2.Id, cancellationToken: TestContext.Current.CancellationToken);
